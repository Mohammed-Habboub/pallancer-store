          ...
          <div class="ps-cart-listing">
            <table class="table ps-cart__table">
              ...
              <tbody>
                ...
                <tr>
                  <td><a class="ps-product__preview" href="{{ route('products.show', $item->product->slug) }}"><img width="60" class="mr-15" src="{{ $item->product->image_url }}" alt="">{{ $item->product->name }}</a></td>
